...
--
CREATE DATABASE IF NOT EXISTS `ci_dashboard` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ci_dashboard`;
...
(0, 'Administrator', 'admin@admin.com', '4b75a5a9258e00283e1adc6e314f7729.png', '$2y$10$mk8TG79.ULtkJDavLCixzultorzbor.Rp6yWB8R6iqJkDptzfDD..', 1, 1577535456, 0, '', '+62895380616287', 'Yogyakarta, Indonesia'),
(1, 'Member', 'member@member.com', '5204bb9d961e52e9f41166555d25d094.png', '$2y$10$Km7dyWai22f0KhuUNeIluu73mJyl.Ycpn5hxyx0WY8YtNqYWZVlZm', 2, 1578388063, 0, '', '0', 'Yogyakarta, Indonesia');
